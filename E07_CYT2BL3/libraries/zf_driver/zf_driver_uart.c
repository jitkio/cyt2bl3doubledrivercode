...
volatile stc_SCB_t* scb_module[7] = {SCB0, SCB4, SCB5, SCB3, SCB2, SCB7, SCB1};
...
static void get_uart_config(uart_config_struct *config_struct, uart_tx_pin_enum tx_pin, uart_rx_pin_enum rx_pin)
{
    switch(tx_pin)
    {
        ...
        case  	UART6_TX_P18_1:
        {
            config_struct->tx_port  = GPIO_PRT18;  	
            config_struct->tx_pin   = 1;      
            config_struct->tx_hsiom = P18_1_SCB1_UART_TX; 
            config_struct->uart_pclk= PCLK_SCB1_CLOCK;
            config_struct->uart_irqn= scb_1_interrupt_IRQn;
        }break;
    ...
    switch(rx_pin)
    {
        ...
        case  	UART6_RX_P18_0: 
        {
            config_struct->rx_port  = GPIO_PRT18;  	
            config_struct->rx_pin   = 0;      
            config_struct->rx_hsiom = P18_0_SCB1_UART_RX; 
            config_struct->uart_pclk= PCLK_SCB1_CLOCK;
            config_struct->uart_irqn= scb_1_interrupt_IRQn;
        }break;
        default: zf_assert(0);     break;
...
volatile stc_SCB_t* get_scb_module(uart_index_enum uart_n)
{
    ...
    switch(uart_n)
    {
        ...
        case UART_6: temp_module = SCB1; break;
        default: zf_assert(0);     break;
    }
    return temp_module;
}

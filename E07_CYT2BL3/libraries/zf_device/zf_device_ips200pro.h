...
#define IPS200PRO_CLK_PIN                  	( SPI3_CLK_P13_2    )   // 硬件 SPI SCK 引脚
#define IPS200PRO_MOSI_PIN                 	( SPI3_MOSI_P13_1   )   // 硬件 SPI MOSI 引脚
#define IPS200PRO_MISO_PIN                 	( SPI_MISO_NULL     )   // 硬件 SPI MISO 引脚  TFT没有MISO引脚，但是这里任然需要定义，在spi的初始化时需要使用
#define IPS200PRO_RST_PIN                  	( P12_0             )   // 液晶复位引脚定义
#define IPS200PRO_INT_PIN                  	( P12_1             )   // 液晶命令位引脚定义
#define IPS200PRO_CS_PIN                   	( P13_3             )   // CS 片选引脚
